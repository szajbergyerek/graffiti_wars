...
@bp_assets.route("/assets/models/<path:relative_path>")
def serve_model(relative_path: str):
    return send_from_directory(current_app.config["MODELS_ROOT"], relative_path)
